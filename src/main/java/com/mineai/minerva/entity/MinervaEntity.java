...
public class MinervaEntity extends PathfinderMob {
    ...
    public static final EntityDataAccessor<String> CUSTOM_NAME = SynchedEntityData.defineId(MinervaEntity.class,
    ...
    public static boolean canSpawn(EntityType<?> type, ServerLevelAccessor level,
            EntitySpawnReason entitySpawnReason, BlockPos pos, RandomSource random) {
        // return level.getBlockState(pos.below()).getMaterial().isSolid() &&
        // !level.isNight();
        return true; // TODO: if we want to have conditions around spawning, for now
        // it can always spawn
    }

    @Override
    protected void registerGoals() {
        // Example AI goals here — required: we need to add goals for any entity that
        // exists
