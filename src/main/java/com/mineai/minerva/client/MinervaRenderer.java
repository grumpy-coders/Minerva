 ...
 * 
 * public class MinervaRenderer extends MobRenderer<MinervaEntity,
 * MinervaModel<MinervaEntity>> {
 * 
 * public MinervaRenderer(EntityRendererProvider.Context context) {
 * //super(context, new MinervaModel<>(context.bakeLayer(ModelLayers.PLAYER)),
 * 0.5f);
 * super(context, new MinervaModel(context.bakeLayer(LAYER_LOCATION)));
 * }
 * 
 * private static final ResourceLocation TEXTURE_LOCATION =
 * ResourceLocation.fromNamespaceAndPath(MinervaMod.MODID,
 * "textures/entity/minerva_entity.png");
 * 
 * public static final ModelLayerLocation LAYER_LOCATION = new
 * ModelLayerLocation(TEXTURE_LOCATION, "main");
 * 
 * @Override
